...
company = Company()
company.name = 'SGPH'
company.ruc = '0603160664001'
company.email = 'palaciodelhogar@palaciodelhogar.com'
company.phone = ''
company.mobile = '0984880654'
company.desc = 'Ventas de Productos para el hogar.'
company.website = 'palacios.com'
company.address = 'Parque California 2, Vía Daule'
company.iva = 12.00
company.save()
...
group.save()
print('insertado {}'.format(group.name))
for m in Module.objects.filter(url__in=['/crm/client/update/profile/', '/pos/crm/sale/client/', '/user/update/password/']).exclude():
    gm = GroupModule()
    gm.module = m
    gm.group = group
    gm.save()
...
u = User()
u.first_name = 'Andrea Andrea'
u.last_name = 'Andrea Andrea'
u.username = 'admin'
u.dni = '0928363993'
u.email = 'andrest.9324@gmail.com'
u.is_active = True
u.is_superuser = True
u.is_staff = True
