...
class SalePrintPagareView(LoginRequiredMixin, View):
    success_url = reverse_lazy('sale_admin_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {'sale': sale, 'company': Company.objects.first()}
            if sale.type_voucher == 'ticket':
                template = get_template('crm/sale/print/pagare.html')
                context['height'] = self.get_height_ticket()
            else:
                template = get_template('crm/sale/print/pagare.html')
            html_template = template.render(context).encode(encoding="UTF-8")
...
class SalePrintContratoView(LoginRequiredMixin, View):
    success_url = reverse_lazy('sale_admin_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {'sale': sale, 'company': Company.objects.first()}
            if sale.type_voucher == 'ticket':
                template = get_template('crm/sale/print/contrato.html')
                context['height'] = self.get_height_ticket()
            else:
                template = get_template('crm/sale/print/contrato.html')
            html_template = template.render(context).encode(encoding="UTF-8")
...
class SalePrintTitleView(LoginRequiredMixin, View):
    success_url = reverse_lazy('sale_admin_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {'sale': sale, 'company': Company.objects.first()}
            if sale.type_voucher == 'ticket':
                template = get_template('crm/sale/print/title.html')
                context['height'] = self.get_height_ticket()
            else:
                template = get_template('crm/sale/print/title.html')
            html_template = template.render(context).encode(encoding="UTF-8")
...
class SalePrintPromisView(LoginRequiredMixin, View):
    success_url = reverse_lazy('sale_admin_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {'sale': sale, 'company': Company.objects.first()}
            if sale.type_voucher == 'ticket':
                template = get_template('crm/sale/print/promis.html')
                context['height'] = self.get_height_ticket()
            else:
                template = get_template('crm/sale/print/promis.html')
            html_template = template.render(context).encode(encoding="UTF-8")
