...
$(function() {
    ...
    console.log('entra cat',select_category);
    select_marca = $('select[name="marca"]');
    console.log('entra m',select_marca);
    ...
    $('#id_price').on('change', function() {
        ...
        var precio = 0.00
        var sum = 0.00
        precio = parseFloat((selectValor * 128) / 100);
        suma = parseFloat(precio) + parseFloat(selectValor);
        input_pvp.value = suma.toFixed(2);
