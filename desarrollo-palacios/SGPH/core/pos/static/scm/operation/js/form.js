...
var input_observacion;
var input_searchproducts;
var inputCredit;
var select_sucorigen;
var select_sucdestino;
...
$(function() {
    ...
    input_observacion = $('input[name="observacion"]');
    select_provider = $('select[name="provider"]');
    input_searchproducts = $('input[name="searchproducts"]');
    select_sucorigen = $('select[name="sucorigen"]');
    select_destino = $('select[name="sucdestino"]');
