        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    buttons += '<a href="/pos/scm/operation/delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash"></i></a> ';
                    buttons += '<a href="/pos/scm/operation/print/request/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Solicitud"><i class="fas fa-print"></i></a> ';
