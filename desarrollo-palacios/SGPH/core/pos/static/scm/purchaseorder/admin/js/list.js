        ...
        columnDefs: [{
...

            {
                ...
                render: function(data, type, row) {
                    ...
                    if (row.state === 'Aprobar') {
                        buttons += '<a href="/pos/scm/purchaseorder/print/request/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Orden"><i class="fas fa-print"></i></a> ';
