        ...
        columnDefs: [{
...

            {
                ...
                render: function(data, type, row) {
                    ...
                    buttons += '<a href="/pos/scm/serie/delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash"></i></a> ';
                    buttons += '<a href="/pos/scm/serie/update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat" title= "Editar"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/pos/scm/serie/print/request/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Orden"><i class="fas fa-print"></i></a> ';
