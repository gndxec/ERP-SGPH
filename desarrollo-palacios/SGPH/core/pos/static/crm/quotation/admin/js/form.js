...
var vents = {
    ...
    calculate_invoice: function() {
        ...
        console.log('dscto', vents.details.dscto);
            ...
            submit_formdata_with_ajax('Notificación',
                ...
                function(request) {
                    dialog_action('Notificación', '¿Desea Imprimir la cotización?', function() {
                        window.open('/pos/crm/quotation/print/voucher/' + request.id + '/', '_blank');
...
function printInvoice(id) {
    var printWindow = window.open("/pos/crm/quotation/print/voucher/" + id + "/", 'Print', 'left=200, top=200, width=950, height=500, toolbar=0, resizable=0');
...
$(function() {
    ...
    //pricelist dependiendo de plazo
