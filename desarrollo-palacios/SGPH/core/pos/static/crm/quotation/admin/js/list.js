        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    buttons += '<a href="/pos/crm/quotation/print/voucher/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Cotización"><i class="fas fa-print"></i></a> ';
                    //buttons += '<a href="/pos/crm/quotation/admin/delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat" title= "Eliminar"><i class="fas fa-trash"></i></a> ';
                    //obadd
                    //buttons += '<a href="/pos/crm/quotation/print/title/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat" title= "Título de Propiedad/Acta de recepción"><i class="fas fa-print"></i></a> ';
